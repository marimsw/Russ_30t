...
# Загружаем файл CSV
df = pd.read_csv('D:/MSDis/30 тысяч/28.02 Кредит_Ипотека.csv', encoding='utf-8')
...
output_file = '28.02 Кредит_Ипотека30тысv3.txt'  # Имя файла для сохранения результатов
