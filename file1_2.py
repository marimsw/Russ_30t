...
source_directory = "C:/Загрузки/30 тысяч/russ2024y_cleaned"  # Исходная директория с изображениями
destination_directory = "D:/MSDis/30 тысяч/Кредит_Ипотека_30t" # Целевая директория для копирования
txt_file = "28.02 Кредит_Ипотека30тысv3.txt"  # Путь к вашему txt файлу
